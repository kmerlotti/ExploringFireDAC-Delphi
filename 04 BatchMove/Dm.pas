...
type
  TDtm = class(TDataModule)
    ...
    SqlClientesDataNascimento: TWideStringField;
...
begin
  case APhase of
    psPreparing: ;
    psStarting: Form1.UpdateProgress(True);
    psProgress: Application.ProcessMessages();
    psFinishing: Form1.UpdateProgress(False);
    psUnpreparing: ;
  end;

end;

procedure TDtm.GetData;
begin
  SqlClientes.Close();
  SqlClientes1.Close();
  SqlClientes.Open();
...
procedure TDtm.EmptyInterbaseTable;
begin
