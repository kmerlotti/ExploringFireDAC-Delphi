...
uses
  ...
  Data.Bind.Grid, Vcl.Grids, Data.Bind.DBScope, Vcl.DBGrids, Vcl.ComCtrls, Vcl.Menus;
...
type
  ...
  public
    { Public declarations }
    procedure UpdateProgress(Activate: Boolean);
  end;
...
procedure TForm1.UpdateProgress(Activate: Boolean);
begin
  case Activate of
